window.masterData = [
    ...
    // --- CATEGORY: Altostrat Case Study ---
    {
        ...
        a: '1. **Performance**: Intent is to deploy GenAI Agents (Vertex AI).\n2. **Reliability**: Intent is to establish SLA-backed hybrid connectivity (Interconnect).\n3. **Cost**: Intent is to use automated tiering (GCS Autoclass).\n4. **Security/Operational Excellence**: Intent is to use Explainable AI and Model Armor for compliance.',
        ...
        t: 'Heuristic: If it mentions "24/7" or "Natural Language," it is a Performance/UX requirement. If it mentions "Cost" or "TCO," it is a Cost pillar requirement.',
    ...
    },
    {
        ...
        c: 'To achieve 99.99% HA, you must use 4 circuits (2 per metro across 2 metros) and 2 Cloud Routers. For throughput, use LACP (Link Aggregation) to bundle multiple 10G or 100G circuits into a single logical pipe.',
    },
    {
        cat: 'Altostrat',
    ...
    {
        cat: 'Altostrat',
        q: 'Scenario: Altostrat wants to increase engagement via a 24/7 support chatbot. Requirements: "Enable 24/7 user support via natural language interactions" [BR-1], prevent prompt injection/harmful content [TR-3], and ensure only valid subscribers can access the interface.',
